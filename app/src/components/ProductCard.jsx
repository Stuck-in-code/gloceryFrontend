          ...
          <div className="flex items-end justify-between mt-3">
            ...
            >
              {!cartItems[product._id] ? (
                <button
                  className="flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-20 w-16 h-8.5 rounded text-indigo-500 font-medium cursor-pointer"
